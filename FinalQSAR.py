...
def main():
    ...
    with st.container():
        ...
        st.image(
            "https://images.unsplash.com/photo-1581093588401-6f76f86f8696?ixlib=rb-4.0.3&auto=format&fit=crop&w=1350&q=80",
    ...
    if uploaded_file is not None:
        ...
        try:
            ...
            exclude_columns = st.multiselect(
                ...
                options=all_columns, 
                default=[], 
                help="Select columns that should be excluded from the analysis (e.g., ID, irrelevant features)."
            )
                    ...
                    try:
                        ...
                        if not best_models:
                            ...
                            st.download_button(
                                ...
                                # icon parameter is available from Streamlit v1.18 onwards
                                # If using an older version, you might need to omit the 'icon' parameter
                                # icon="📥"
                            )
